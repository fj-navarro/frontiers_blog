...
**The idea of quantum computing emerged years ago from the reflections of a bunch of scientists about what the fundamental limits of computing were. What they assumed was that if technology continued to comply with [Moore's Law](https://en.wikipedia.org/wiki/Moore%27s_law), that is, if the number of transistors in a microprocessor doubled approximately every two years, then the decreasing size of the circuits within a silicon chip would eventually reach a point where individual elements would not exceed the size of a few atoms.**
...
[Richard Feynman](https://en.wikipedia.org/wiki/Richard_Feynman) was one of the first to tackle this challenge in 1982 by creating an abstract model showing how a quantum system could be used to do calculations. The model explained how a machine could have the ability to perform quantum physics experiments inside a quantum mechanical computer.

<p><center><img src="index_files/quantum-computing-applications-1.jpg" alt="Richard Feynman"> </center>
<center>Image: Richard Feynman (Source: Consciousness Create Reality)</center></p>

Later, in 1985, it was [David Deutsch](https://en.wikipedia.org/wiki/David_Deutsch) who proposed the possibility that a quantum computer could be general purpose and published a [theoretical paper](https://royalsocietypublishing.org/doi/10.1098/rspa.1985.0070) that went on to show how a quantum computer could have capabilities far beyond those of a traditional classical computer. After Deutsch's article, the race to develop practical applications for the quantum computer machine was kicked off.
...
The world's leading technology champions, such as [IBM](https://www.ibm.com/), [Google](https://www.google.com/about/careers/applications/?utm_campaign=profilepage&utm_medium=profilepage&utm_source=linkedin&src=Online/LinkedIn/linkedin_page), [Microsoft](https://news.microsoft.com/source/) and [Intel](https://www.intel.la/content/www/xl/es/homepage.html), as well as some rather ambitious startups such as [Rigetti Computing](https://www.rigetti.com/) and [IonQ](https://ionq.com/), are racing to develop the first large-scale universal quantum computer that could solve many computationally complex and intractable problems, including problems in areas of data science, finance, drug design, etc.
...
Top tech companies quantum initiatives like [IBM Quantum](https://www.ibm.com/quantum), [Google Cloud](https://cloud.google.com), [Microsoft Azure Cloud](https://azure.microsoft.com/), [Amazon Web Services (AWS) Braket](https://aws.amazon.com/es/braket/) combine quantum computers with cloud computing that do not need to have a physical quantum computer installed. In this way, users have the opportunity to access quantum computers in the cloud to solve complex problems that require powerful computing.
...
<p><center><img src="index_files/quantum-computing-applications-3.png" alt="Google quantum computer"> </center>
<center>Image: Google quantum computer at the Quantum AI campus in Goleta, California 2022 (Source: Getty Images)</center></p>
